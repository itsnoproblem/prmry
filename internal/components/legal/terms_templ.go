...
func TermsOfService() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, err = templBuffer.WriteString("<div class=\"container terms-of-service legal-page\">")
		if err != nil {
			return err
		}
		...
		_, err = templBuffer.WriteString(" <a href=\"mailto:help@prmry.io\">")
		if err != nil {
			return err
		}
		...
		_, err = templBuffer.WriteString("</a></p><h4>")
		if err != nil {
			return err
		}
		...
		_, err = templBuffer.WriteString("</h4></div>")
		if err != nil {
			return err
		}
		if !templIsBuffer {
