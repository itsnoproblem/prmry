...
func RuleBuilder(view Detail) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" class=\"p-4 ps-2\"")
		if err != nil {
			return err
		}
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" class=\"col text-left\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" for=\"require-all\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(" class=\"pt-1 pe-2 larger\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		_, err = templBuffer.WriteString(" id=\"require-all\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(" class=\"rounded p-1\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(" placeholder=\"Choose...\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		_, err = templBuffer.WriteString(" class=\"btn btn-info btn-sm ms-3\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		_, err = templBuffer.WriteString(" class=\"container p-4 ps-2\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		if len(view.Rules) == 0 {
			...
			// Element Attributes
			_, err = templBuffer.WriteString(" class=\"text-left\"")
			if err != nil {
				return err
			}
			_, err = templBuffer.WriteString(">")
			...
			// Element Attributes
			_, err = templBuffer.WriteString(" class=\"pb-2 text-body-secondary\"")
			if err != nil {
				return err
			}
			_, err = templBuffer.WriteString(">")
		...
		for i, rule := range view.Rules {
			...
			if rule.Field.Source == flow.FieldSourceFlow.String() {
				...
				// TemplElement
				err = FieldSelector(fmt.Sprintf("selectedFlows-%d", i), "selectedFlows", view.AvailableFlowsByID, rule.Field.Value, "Flow").Render(ctx, templBuffer)
				if err != nil {
					return err
				}
				_, err = templBuffer.WriteString("</div>")
