...
func FlowBuilder(view Detail) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" class=\"col col-5 mt-3\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
...
func FlowsListPage(view FlowsListView) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		err = page.Page(&view).Render(templ.WithChildren(ctx, var_28), templBuffer)
		if err != nil {
			return err
		}
		if !templIsBuffer {
...
func FlowsList(view FlowsListView) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" class=\"col-1\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		// Element Attributes
		_, err = templBuffer.WriteString(" scope=\"col d-none d-lg-table-cell\"")
		if err != nil {
			return err
		}
		_, err = templBuffer.WriteString(">")
		...
		for _, f := range view.Flows {
			...
			// StringExpression
			var var_37 string = f.LastChanged
